...
// ============================================
// MANUAL CONFIGURATION FOR POWER MEASUREMENT
// ============================================
// Change MANUAL_TEST_MODE and re-upload for each test run
// MANUAL_TEST_MODE:
//   1 = Hybrid (BLE baseline + WiFi bulk)
//   2 = WiFi only (baseline + bulk both via WiFi)
// The code will automatically cycle through Cases 2, 3, 4
...
int currentTestMode = MANUAL_TEST_MODE;  // Use manual configuration
...
// Phase tracking (cycles through 2, 3, 4)
int currentPhase = 2;
...
void setup() {
  ...
  Serial.print("Manual TEST_MODE: ");
  Serial.println(MANUAL_TEST_MODE);
  Serial.println("Auto-cycling through Cases 2, 3, 4 (30 seconds each)");
  Serial.print("\n[PHASE 2] TEST_MODE=");
  Serial.print(MANUAL_TEST_MODE);
  Serial.println(", DELAY_TOLERANCE=5000ms (moderate)");
}
...
void checkAndSwitchPhase() {
  ...
  // Switch to next phase (cycle through 2, 3, 4)
  currentPhase++;
  if (currentPhase > 4) currentPhase = 2;  // Loop back to phase 2
  ...
  switch (currentPhase) {
    case 2:
      // Phase 2: DELAY_TOLERANCE 5000ms (moderate)
    ...
    case 3:
      // Phase 3: DELAY_TOLERANCE 12000ms (high - more BLE, less WiFi)
      currentDelayTolerance = 12000;
      currentProb20 = 70;
      currentProb60 = 30;
      Serial.print("\n[PHASE 3] TEST_MODE=");
      Serial.print(MANUAL_TEST_MODE);
      Serial.println(", DELAY_TOLERANCE=12000ms (high - more BLE, less WiFi)");
      break;

    case 4:
      // Phase 4: DELAY_TOLERANCE 2000ms (low - less BLE, more WiFi)
      currentDelayTolerance = 2000;
      currentProb20 = 70;
      currentProb60 = 30;
      Serial.print("\n[PHASE 4] TEST_MODE=");
      Serial.print(MANUAL_TEST_MODE);
      Serial.println(", DELAY_TOLERANCE=2000ms (low - less BLE, more WiFi)");
      break;
  }
}
